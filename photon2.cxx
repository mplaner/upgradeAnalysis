...
void Loop(int filenum,TTree *tree,TH1F *r9EEHist0,TH1F *r9EEHist1,TH1F *r9EEsleHist0,TH1F *r9EEsleHist1)
{
...
void inverseintegrateHis(TH1F *hist1,TH1F *hist2)
 {
   ...
   {
       sum +=hist1->GetBinContent(i);
       hist2->SetBinContent(size-i-1,sum);
   }
 }
...
void onegroup(TTree *tree1,TTree *tree2)
{
 ...
 // TH1F * r9EBHist[2];
  TH1F * r9EEHist[2];
  TH1F * r9EEsleHist[2];
  r9EEHist[0]=new TH1F("hname_","hname_",50,0,1);
  r9EEsleHist[0]=new TH1F("hname__","hname_",50,0,1);
  r9EEHist[1]=new TH1F("hname_1","hname_1",50,0,1);
  r9EEsleHist[1]=new TH1F("hname_11","hname_",50,0,1);
/*  TH1F * hovereEBHist[2];
  TH1F * hovereEEHist[2];
  TH1F * sigmIetIetaEBHist[2];
  TH1F * sigmIetIetaEEHist[2];*/
  Loop(0,tree1,r9EEHist[0],r9EEHist[1],r9EEsleHist[0],r9EEsleHist[1]);
  Loop(1,tree2,r9EEHist[0],r9EEHist[1],r9EEsleHist[0],r9EEsleHist[1]);
  normalize(r9EEHist[0]);
  normalize(r9EEHist[1]);
  integrateHis(r9EEHist[0],r9EEsleHist[0]); 
//  integrateHis(r9EEHist[1],r9EEsleHist[1]); 
  inverseintegrateHis(r9EEHist[1],r9EEsleHist[1]);
  r9EEsleHist[0]->Draw();
  r9EEsleHist[1]->SetLineColor(6);
  r9EEsleHist[1]->Draw("SAME");
}
